...
app.post('/api/users', function (req, res) {
	...
	ExerciseUsers.findOne({ username: username }).then(function (err, data) {
		if (!err && data === null) {
...
app.get('/api/users', function (req, res) {
	ExerciseUsers.find({}).then(function (err, data) {
		if (!err) {
...
app.post('/api/users/:_id/exercises', function (req, res) {
	...
	ExerciseUsers.findById(userId).then(function (err, data) {
		if (!err && data !== null) {
